...
nanorc_command_list = (
    "boot conf".split()
    + " start --run-number 101 wait 1 enable-dfo enable-triggers wait 2 disable-triggers wait 2 drain-dataflow stop-trigger-sources stop wait 2".split()
    + " start --run-number 102 wait 1 change-rate --trigger-rate 2.0 enable-dfo enable-triggers wait 1 disable-triggers wait 2 drain-dataflow stop-trigger-sources stop wait 2".split()
    + " start --run-number 103 wait 1 change-rate --trigger-rate 0.1 enable-dfo enable-triggers wait 20 disable-triggers wait 2 drain-dataflow stop-trigger-sources stop wait 2".split()
    + " start --run-number 104 wait 1 change-rate --trigger-rate 0.01 enable-dfo enable-triggers wait 200 disable-triggers wait 2 drain-dataflow stop-trigger-sources stop wait 2".split()
