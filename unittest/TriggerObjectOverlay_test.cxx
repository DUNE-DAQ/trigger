...
BOOST_AUTO_TEST_CASE(TriggerCandidateOverlay_in_out)
{
  ...
  triggeralgs::TriggerCandidate candidate_read =
    triggeralgs::read_overlay_from_buffer<triggeralgs::TriggerCandidate>(buffer);
...
BOOST_AUTO_TEST_CASE(TriggerActivityOverlay_in_out)
{
  ...
  triggeralgs::TriggerActivity activity_read =
    triggeralgs::read_overlay_from_buffer<triggeralgs::TriggerActivity>(buffer);
