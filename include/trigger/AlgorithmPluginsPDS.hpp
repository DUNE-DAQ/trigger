...
#ifndef TRIGGER_INCLUDE_TRIGGER_ALGORITHMPLUGINSPDS_HPP_
#define TRIGGER_INCLUDE_TRIGGER_ALGORITHMPLUGINSPDS_HPP_
 ...
 */
inline std::unique_ptr<triggeralgs::TriggerActivityMakerPDS>
make_ta_maker(std::string const& plugin_name)
{
  auto ta_factory = triggeralgs::TriggerActivityFactoryPDS::get_instance();
 ...
 */
inline std::unique_ptr<triggeralgs::TriggerCandidateMakerPDS>
make_tc_maker(std::string const& plugin_name)
{
  auto tc_factory = triggeralgs::TriggerCandidateFactoryPDS::get_instance();
...
#endif // TRIGGER_INCLUDE_TRIGGER_ALGORITHMPLUGINSPDS_HPP_
