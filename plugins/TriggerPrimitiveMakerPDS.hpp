...
#ifndef TRIGGER_PLUGINS_TRIGGERPRIMITIVEMAKERPDS_HPP_
#define TRIGGER_PLUGINS_TRIGGERPRIMITIVEMAKERPDS_HPP_

#include "trigger/TPSetPDS.hpp"
...
namespace dunedaq {
namespace trigger {
class TriggerPrimitiveMakerPDS : public dunedaq::appfwk::DAQModule
{
public:
  /**
   ...
   */
  explicit TriggerPrimitiveMakerPDS(const std::string& name);

  TriggerPrimitiveMakerPDS(const TriggerPrimitiveMakerPDS&) = delete; ///< TriggerPrimitiveMaker is not copy-constructible
  TriggerPrimitiveMakerPDS& operator=(const TriggerPrimitiveMakerPDS&) =
    delete;                                                ///< TriggerPrimitiveMaker is not copy-assignable
  TriggerPrimitiveMakerPDS(TriggerPrimitiveMakerPDS&&) = delete; ///< TriggerPrimitiveMaker is not move-constructible
  TriggerPrimitiveMakerPDS& operator=(TriggerPrimitiveMakerPDS&&) = delete; ///< TriggerPrimitiveMaker is not move-assignable
...
private:
  ...
  // Configuration
  triggerprimitivemakerpds::ConfParams m_conf;
...
#endif // TRIGGER_PLUGINS_TRIGGERPRIMITIVEMAKERPDS_HPP_
