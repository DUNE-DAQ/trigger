...
#include "TriggerActivityMakerPDS.hpp"
...
std::unique_ptr<triggeralgs::TriggerActivityMakerPDS>
TriggerActivityMaker::make_maker(const nlohmann::json& obj)
{
  ...
  std::unique_ptr<triggeralgs::TriggerActivityMakerPDS> maker = make_ta_maker(params.activity_maker);
...
DEFINE_DUNE_DAQ_MODULE(dunedaq::trigger::TriggerActivityMakerPDS)
