 ...
 *
 * TPReplayModule is a DAQModule for replaying trigger primitives in the system.
 *
...
public:
  /**
   * @brief TPReplayModule Constructor
   * @param name Instance name for this TPReplayModule instance
   */
