...
private:
  ...
  std::map<int, trgdataformats::TriggerCandidateData::Type> m_HLT_TC_map = {
    ...
    { 3, trgdataformats::TriggerCandidateData::Type::kCTBCustomD },
    { 4, trgdataformats::TriggerCandidateData::Type::kCTBCustomE },
    { 5, trgdataformats::TriggerCandidateData::Type::kCTBCustomF },
    { 6, trgdataformats::TriggerCandidateData::Type::kCTBCustomG },
    ...
    { 10, trgdataformats::TriggerCandidateData::Type::kCTBOffSpillSnapshot},
    { 11, trgdataformats::TriggerCandidateData::Type::kCTBOffSpillCosmicJura },
    { 12, trgdataformats::TriggerCandidateData::Type::kCTBOffSpillCRTCosmic},
