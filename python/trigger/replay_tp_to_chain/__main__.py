...
@click.option('--trigger-activity-plugin', default='TAMakerPrescaleAlgorithm', help="Trigger activity algorithm plugin")
...
@click.option('--trigger-candidate-plugin', default='TCMakerPrescaleAlgorithm', help="Trigger candidate algorithm plugin")
